...
<html class="no-js" lang="">
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/user/assets/img/favicon.svg"/>
    <!-- Place favicon.ico in the root directory -->

    <!-- ========================= CSS here ========================= -->
    <link rel="stylesheet" href="/user/assets/css/bootstrap-5.0.0-alpha-2.min.css" />
    <link rel="stylesheet" href="/user/assets/css/LineIcons.2.0.css" />
  ...
  <body>
            ...
            <div class="col-lg-12">
              <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="index.html">
                  <img src="/user/assets/img/logo/logo.svg" alt="Logo" />
                </a>
      ...
      <div class="container">
              ...
              <div class="hero-btns">
					...
					<div class="col-lg-6">
						<div class="hero-img wow fadeInUp" data-wow-delay=".5s">
							<img src="/user/assets/img/hero/hero-img.png" alt="">
						</div>
					</div>
        </div>
	</div>
			<div class="hero-shape">
				<img src="/user/assets/img/hero/hero-shape-1.svg" alt="" class="shape shape-1">
			</div>
    </section>
		<!-- ========================= hero-section end ========================= -->
		...
		<section id="tracking" class="tracking-section pt-150">
			<div class="tracking-shape">
				<img src="/user/assets/img/plan/plan-shape.svg" alt="" class="shape shape-1">
			</div>
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6 col-xl-7">
						<div class="tracking-image">
							<img src="/user/assets/img/plan/plan-img.png" alt="">
						</div>
					</div>
		...
		<section class="search-section pt-150">
			<div class="search-shape">
				<img src="/user/assets/img/search/search-shape.svg" alt="" class="shape shape-1">
			</div>
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-xl-7 col-lg-6">
						<div class="search-img text-lg-right">
							<img src="/user/assets/img/search/search-img.png" alt="">
						</div>
					</div>
				</div>
			</div>
		...
		<section class="counter-up-section pt-150">
			<div class="counter-shape">
				<img src="/user/assets/img/count-up/counter-shape.svg" alt="" class="shape shape-1">
			</div>
			<div class="container">
				<div class="row align-items-center">
					<div class="col-xl-7 col-lg-6">
						<div class="counter-up-img">
							<img src="/user/assets/img/count-up/count-up-img.png" alt="">
						</div>
					</div>
    ...
    <!-- ========================= testimonial-section end ========================= -->
		...
		<section id="download" class="download-section pt-130 pb-130">
			<div class="map-bg">
				<img src="/user/assets/img/download/map-bg.svg" alt="">
			</div>
			<div class="download-shape">
				<img src="/user/assets/img/download/download-shape.svg" alt="" class="shape shape-1">
			</div>
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6">
						<div class="download-img mb-50 text-lg-right">
							<img src="/user/assets/img/download/download-img.png" alt="">
						</div>
					</div>
				</div>
			</div>
    ...
    <footer id="footer" class="footer">
			<div class="footer-shape">
				<img src="/user/assets/img/footer/footer-shape-1.svg" alt="" class="shape shape-1">
			</div>
			<div class="container">
					...
					<div class="row">
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
							<div class="footer-widget">
								<div class="logo">
									<a href="index.html">
										<img src="/user/assets/img/logo/logo-2.svg" alt="" class="logo-2"> 
										<img src="/user/assets/img/logo/logo.svg" alt="" class="logo-1"> 
									</a>
								</div>
								<ul class="socials">
									<li>
    ...
    <!-- ========================= JS here ========================= -->
    <script src="/user/assets/js/bootstrap.5.0.0.alpha-2-min.js"></script>
    <script src="/user/assets/js/count-up.min.js"></script>
